...
This project demonstrates the implementation of a highly available and scalable application infrastructure on AWS using Amazon EC2, Application Load Balancer, Auto Scaling Group, Amazon CloudWatch, and Amazon SNS.

The infrastructure was manually configured and tested in AWS to demonstrate how application instances can automatically scale based on CPU utilization and how CloudWatch and SNS can be used for monitoring and notifications.
...
CPU Utilization Alarm
  ↓
Auto Scaling Action / SNS Notification
...
| Auto Scaling Group | Maintains desired instance capacity and performs scaling |
| Amazon CloudWatch | Monitors EC2 CPU utilization |
| Amazon SNS | Sends notification alerts |
| IAM | Provides required permissions and roles |

---

# 🔹 1. AWS Networking

The project uses the AWS default VPC and its existing subnets for deploying the EC2 instances and associated resources.

---

# 🔹 2. EC2 Instance

An EC2 instance was configured to host the application.
...
- Application/Web Server configured on the instance
...
An Application Load Balancer was configured to distribute incoming application traffic across EC2 instances.
...
- Health checks configured for EC2 instances
...
The EC2 instances were registered with the target group.

The target group continuously performs health checks to ensure that traffic is sent only to healthy instances.
...
An Auto Scaling Group was configured to automatically manage EC2 instance capacity.
...
The Auto Scaling Group automatically launches or terminates instances based on the configured scaling conditions.
...
Amazon CloudWatch was configured to monitor EC2 instance CPU utilization.

A CloudWatch alarm was created to monitor CPU usage and trigger the required scaling action when the configured threshold is reached.
...
The increased CPU utilization triggered the CloudWatch alarm and the Auto Scaling Group launched an additional EC2 instance.

![Scaling Activity](images/scaling-activity.png)
...
# AWS Auto Scaling, Monitoring & SNS Notification
